          ...
          <div class="modal-background" id="myModal">
            <div class="modal-main">
              ...
              <div class="modal-bottom-div">
                  ...
                  <div class="list-main">
                    <ol>
                      <li>
                        ...
                        <h5>
                          Answer : <span class="right wrong">fdjhkdfh</span>
                        </h5>
                      </li>
                ...
                <div class="bottom-left-score">
                  <div class="modal-score" style="background-color: #deafe1">
                    <h4>Score</h4>
                    <span>11/30</span>
                  </div>

                  <div
                    class="modal-percentage"
                    style="background-color: #4ebc67"
                  >
                    <h4>Percentage</h4>
                    <span>11/30</span>
                  </div>
            ...
            <table class="MainTable">
              <thead class="tableheading">
                <tr>
                  ...
                  <th style="font-weight: 800; color: white">Teacher Name</th>
              ...
              <tbody class="tablebody">
                <tr>
                  ...
                  <td style="font-weight: 500">
                    <a href="completed" style="color: #55d0ff; font-weight: 600"
                      >N5-10</a
                    >
                  </td>
                  <td style="font-weight: 500">1st April 2024</td>
                  <td style="font-weight: 500">30 May 2024</td>
                  <td style="font-weight: 500">Matsunga san</td>
                  <td style="font-weight: 500">

            ...
            <table class="MainTable">
              <thead class="tableheading">
                <tr>
                  ...
                  <th style="font-weight: 800; color: white">Test 1</th>
                  <th style="font-weight: 800; color: white">Homework</th>
                  <th style="font-weight: 800; color: white">Days</th>
                  <th style="font-weight: 800; color: white">Date</th>
                  <th style="font-weight: 800; color: white">File Upload</th>
              ...
              <tbody class="tablebody">
                <tr>
                  ...
                  <td style="font-weight: 500">Test 1</td>
                  <td style="font-weight: 500">Monday</td>
                  <td style="font-weight: 500">01/01/2024</td>
                  ...
                  <td style="font-weight: 500">
                    <i
                      ...
                      style="padding: 10px; color: #24c9a6"
                    ></i>
